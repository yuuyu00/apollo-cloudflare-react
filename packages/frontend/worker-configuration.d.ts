/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4b05dd0df3515166225860ac187f5208)
// Runtime types generated with workerd@1.20250902.0 2024-11-25 
declare namespace Cloudflare {
	interface Env {
		VITE_GRAPHQL_ENDPOINT: string;
		VITE_CLERK_PUBLISHABLE_KEY: string;
		VITE_IMAGE_UPLOAD_URL: string;
		VITE_IMAGES_ENDPOINT: string;
	}
}
